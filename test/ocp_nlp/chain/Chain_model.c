...
extern int jac_chain_nm5(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
//extern int jac_chain_nm6(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
//extern int jac_chain_nm7(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
//extern int jac_chain_nm8(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
//extern int jac_chain_nm9(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
void VDE_fun_nm5(const real_t* in, real_t* out) {
    ...
    vde_chain_nm5(casadi_arg, casadi_res, casadi_iw, casadi_w, casadi_mem);
}
