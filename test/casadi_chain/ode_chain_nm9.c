...
#else /* CODEGEN_PREFIX */
  #define CASADI_PREFIX(ID) ode_chain_nm9_ ## ID
...
int ode_chain_nm9(void* mem, const real_t** arg, real_t** res, int* iw, real_t* w) {
  ...
  real_t a99=arg[1] ? arg[1][50] : 0;
  real_t a100=(a98-a99);
  real_t a101=(a60*a100);
  a90=(a90+a101);
  a90=(a90/a64);
  a90=(a54*a90);
  a101=(a2*a90);
  ...
  a2=(a0-a2);
  a2=(a19*a2);
  if (res[2]!=0) res[2][105]=a2;
  a4=(a4*a26);
  a98=(a27*a98);
  a4=(a4+a98);
  a6=(a4-a6);
  a6=(a19*a6);
  if (res[2]!=0) res[2][106]=a6;
  a7=(a7*a26);
  a27=(a27*a59);
  a7=(a7+a27);
  a9=(a7-a9);
  ...
  a7=(a25-a7);
  a7=(a19*a7);
  if (res[2]!=0) res[2][113]=a7;
  a7=arg[2] ? arg[2][117] : 0;
  if (res[2]!=0) res[2][114]=a7;
  a7=arg[2] ? arg[2][118] : 0;
  if (res[2]!=0) res[2][115]=a7;
  a7=arg[2] ? arg[2][119] : 0;
  if (res[2]!=0) res[2][116]=a7;
  ...
  if (res[2]!=0) res[2][139]=a19;
  a19=arg[2] ? arg[2][143] : 0;
  if (res[2]!=0) res[2][140]=a19;
  if (res[2]!=0) res[2][141]=a80;
  if (res[2]!=0) res[2][142]=a80;
  if (res[2]!=0) res[2][143]=a12;
  return 0;
}

int ode_chain_nm9_init(int* n_in, int* n_out, int* n_int, int* n_real) {
  if (n_in) *n_in = 4;
  if (n_out) *n_out = 3;
  if (n_int) *n_int = 0;
  if (n_real) *n_real = 0;
...
int ode_chain_nm9_alloc(void** mem, const int* idata, const double* rdata) {
  if (mem) *mem = 0;
  (void)idata;
  (void)rdata;
  return 0;
...
int ode_chain_nm9_free(void* mem) {
  (void)mem;
  return 0;
}

int ode_chain_nm9_sparsity(int i, int *nrow, int *ncol, const int **colind, const int **row) {
  const int* s;
  switch (i) {
    case 0:
    case 4:
...
int ode_chain_nm9_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 3;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 103;
