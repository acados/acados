...
For a high-level overview of the structure and functionality of \acados{}, please see the original publication \cite{verschueren2020}.
...
\begin{table}
    \centering
      \begin{tabular}{cccc}
        ...
        Clarabel & partial & \code{PARTIAL\_CONDENSING\_CLARABEL} & \cite{Clarabel_2024} \\
        \bottomrule
