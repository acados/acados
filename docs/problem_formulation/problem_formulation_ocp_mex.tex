...
A full list of the available options is given on the \href{https://docs.acados.org/python_interface/index.html#acados-ocp-solver-interface-acadosocp-and-acadosocpsolver}{docs page}.
