...
``` eval_rst
.. meta::
   :description: Mathematical problem formulation for acados, including optimal control structured NLP (OCP-NLP), quadratic programming (QP), and dense QP formulations used in SQP methods for nonlinear model predictive control.
