...
``` eval_rst
.. meta::
   :description: Troubleshooting guide for acados solvers including solver status diagnostics, NLP residuals, QP diagnostics, solver initialization tips, and debugging strategies.
