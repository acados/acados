...
``` eval_rst
.. meta::
   :description: Software projects and research publications featuring acados including openpilot, bioptim, Rockit, TuneMPC, applications in robotics, autonomous vehicles, quadrotors, wind turbines, and embedded control systems.
   :keywords: acados projects, acados applications, openpilot, bioptim, Rockit, TuneMPC, quadrotor control, autonomous driving, embedded control, NMPC applications, acados research
```
<!-- just simulation -->
