...
``` eval_rst
.. meta::
   :description: Guide for deploying acados on embedded systems including dSPACE platforms (DS1202, DS1401, DS1403), cross-compilation workflows, CMake toolchain configuration, and real-time control deployment.
   :keywords: embedded acados, dSPACE deployment, cross-compilation, embedded control, real-time control, DS1202, DS1401, DS1403, embedded MPC, CMake cross-compilation
```
