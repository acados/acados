...
static void allocate_ocp_qp_in_basic(const int_t N, const int_t *nx,
                                     const int_t *nu, ocp_qp_in *const qp) {
...
static void allocate_ocp_qp_in_polyhedral(const int_t N, const int_t *nc,
                                          ocp_qp_in *const qp) {
