...
#ifndef ACADOS_OCP_QP_OCP_QP_CONDENSING_HPIPM_EXT_DEP_H_
#define ACADOS_OCP_QP_OCP_QP_CONDENSING_HPIPM_EXT_DEP_H_
...
#endif  // ACADOS_OCP_QP_OCP_QP_CONDENSING_HPIPM_EXT_DEP_H_
