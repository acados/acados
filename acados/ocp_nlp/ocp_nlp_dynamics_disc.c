...
//	ocp_nlp_dynamics_disc_opts *opts = opts_;
    ...
    assert((char *) raw_memory + ocp_nlp_dynamics_disc_memory_calculate_size(config_, dims, opts_) >= c_ptr);
...
void ocp_nlp_dynamics_disc_initialize(void *config_, ocp_nlp_dynamics_dims *dims, void *model_, void *opts_, void *mem_, void *work_)
{
	return;
}
