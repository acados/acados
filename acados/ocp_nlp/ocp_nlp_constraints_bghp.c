...
/* dimension setters */
static void ocp_nlp_constraints_bghp_set_nx(void *config_, void *dims_, int *nx)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->nx = *nx;
}

static void ocp_nlp_constraints_bghp_set_nu(void *config_, void *dims_, int *nu)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->nu = *nu;
}

static void ocp_nlp_constraints_bghp_set_nbx(void *config_, void *dims_, int *nbx)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->nbx = *nbx;
...
static void ocp_nlp_constraints_bghp_set_nbu(void *config_, void *dims_, int *nbu)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->nbu = *nbu;
...
static void ocp_nlp_constraints_bghp_set_ng(void *config_, void *dims_, int *ng)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->ng = *ng;
}

static void ocp_nlp_constraints_bghp_set_nh(void *config_, void *dims_, int *nh)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->nh = *nh;
}

static void ocp_nlp_constraints_bghp_set_ns(void *config_, void *dims_, int *ns)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->ns = *ns;
}

static void ocp_nlp_constraints_bghp_set_np(void *config_, void *dims_, int *np)
{
    ocp_nlp_constraints_bghp_dims *dims = (ocp_nlp_constraints_bghp_dims *) dims_;
    dims->np = *np;
}

void ocp_nlp_constraints_bghp_dims_set(void *config_, void *dims_, char *field, int* value)
{
    if (!strcmp(field, "nx"))
	{
	...
	{
        ocp_nlp_constraints_bghp_set_ns(config_, dims_, value);
	}
