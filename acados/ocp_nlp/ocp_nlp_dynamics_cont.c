...
void ocp_nlp_dynamics_cont_dims_initialize(void *config_, void *dims_, int nx, int nu, int nx1, int nu1)
{
...
static void ocp_nlp_dynamics_cont_cast_workspace(void *config_, void *dims_, void *opts_, void *work_)
{
