...
/* dimension setters */
void ocp_nlp_constraints_bgh_set_nx(void *dims_, int nx)
{
    ocp_nlp_constraints_bgh_dims *dims = (ocp_nlp_constraints_bgh_dims *) dims_;
    dims->nx = nx;
}

void ocp_nlp_constraints_bgh_set_nu(void *dims_, int nu)
{
    ocp_nlp_constraints_bgh_dims *dims = (ocp_nlp_constraints_bgh_dims *) dims_;
    dims->nu = nu;
}

void ocp_nlp_constraints_bgh_set_nbx(void *dims_, int nbx)
{
    ocp_nlp_constraints_bgh_dims *dims = (ocp_nlp_constraints_bgh_dims *) dims_;
    dims->nbx = nbx;
...
void ocp_nlp_constraints_bgh_set_nbu(void *dims_, int nbu)
{
    ocp_nlp_constraints_bgh_dims *dims = (ocp_nlp_constraints_bgh_dims *) dims_;
    dims->nbu = nbu;
...
void ocp_nlp_constraints_bgh_set_ng(void *dims_, int ng)
{
    ocp_nlp_constraints_bgh_dims *dims = (ocp_nlp_constraints_bgh_dims *) dims_;
    dims->ng = ng;
}

void ocp_nlp_constraints_bgh_set_nh(void *dims_, int nh)
{
    ocp_nlp_constraints_bgh_dims *dims = (ocp_nlp_constraints_bgh_dims *) dims_;
    dims->nh = nh;
}

void ocp_nlp_constraints_bgh_set_ns(void *dims_, int ns)
{
    ocp_nlp_constraints_bgh_dims *dims = (ocp_nlp_constraints_bgh_dims *) dims_;
    dims->ns = ns;
}

void ocp_nlp_constraints_bgh_set_np(void *dims_, int np)
{
    assert( np == 0 );  // np, dimension of nonlinear function in quadratic_over_nonlinear constr
...
void ocp_nlp_constraints_bgh_config_initialize_default(void *config_)
{
    ...
    // dimension setters
    config->set_nx = &ocp_nlp_constraints_bgh_set_nx;
    config->set_nu = &ocp_nlp_constraints_bgh_set_nu;
    config->set_nbx = &ocp_nlp_constraints_bgh_set_nbx;
    config->set_nbu = &ocp_nlp_constraints_bgh_set_nbu;
    config->set_ng = &ocp_nlp_constraints_bgh_set_ng;
    config->set_nh = &ocp_nlp_constraints_bgh_set_nh;
    config->set_ns = &ocp_nlp_constraints_bgh_set_ns;
    config->set_np = &ocp_nlp_constraints_bgh_set_np;
    // dimension getters
    config->get_nx = &ocp_nlp_constraints_bgh_get_nx;
    config->get_nu = &ocp_nlp_constraints_bgh_get_nu;
    config->get_nbx = &ocp_nlp_constraints_bgh_get_nbx;
    config->get_nbu = &ocp_nlp_constraints_bgh_get_nbu;
    config->get_ng = &ocp_nlp_constraints_bgh_get_ng;
    config->get_nb = &ocp_nlp_constraints_bgh_get_nb;
    config->get_nh = &ocp_nlp_constraints_bgh_get_nh;
    config->get_ns = &ocp_nlp_constraints_bgh_get_ns;
    config->get_np = &ocp_nlp_constraints_bgh_get_np;
