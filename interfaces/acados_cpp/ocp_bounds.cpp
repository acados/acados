...
vector<int>
calculate_idxb(const vector<double>& lower_bound, const vector<double>& upper_bound) {
...
vector<vector<int>>
calculate_all_idxb(const vector<vector<double>>& lower_bounds, const vector<vector<double>>& upper_bounds) {
