...
int sim_erk_integrator_calculate_submodules_size(sim_solver_config *config, sim_dims *dims)
{
    ...
    extern external_function_dims sim_erk_forward_vde_dims;
    size += calculate_external_function_fcn_ptrs_size(&config->ef_config, &sim_erk_forward_vde_dims);

    extern external_function_dims sim_erk_adjoint_vde_dims;
    size += calculate_external_function_fcn_ptrs_size(&config->ef_config, &sim_erk_adjoint_vde_dims);

    extern external_function_dims sim_erk_hess_vde_dims;
    size += calculate_external_function_fcn_ptrs_size(&config->ef_config, &sim_erk_hess_vde_dims);
...
void *sim_erk_integrator_assign_submodules(sim_solver_config *config, sim_dims *dims, void *raw_memory)
{
    ...
    extern external_function_dims sim_erk_forward_vde_dims;
    submodules->forward_vde = assign_external_function_fcn_ptrs(&config->ef_config, &sim_erk_forward_vde_dims, c_ptr);
    c_ptr += calculate_external_function_fcn_ptrs_size(&config->ef_config, &sim_erk_forward_vde_dims);

    extern external_function_dims sim_erk_adjoint_vde_dims;
    submodules->adjoint_vde = assign_external_function_fcn_ptrs(&config->ef_config, &sim_erk_adjoint_vde_dims, c_ptr);
    c_ptr += calculate_external_function_fcn_ptrs_size(&config->ef_config, &sim_erk_adjoint_vde_dims);

    extern external_function_dims sim_erk_hess_vde_dims;
    submodules->hess_vde = assign_external_function_fcn_ptrs(&config->ef_config, &sim_erk_hess_vde_dims, c_ptr);
    c_ptr += calculate_external_function_fcn_ptrs_size(&config->ef_config, &sim_erk_hess_vde_dims);
