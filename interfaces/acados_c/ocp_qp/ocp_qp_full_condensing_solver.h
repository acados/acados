...
#ifndef ACADOS_C_OCP_QP_OCP_QP_FULL_CONDENSING_SOLVER_H_
#define ACADOS_C_OCP_QP_OCP_QP_FULL_CONDENSING_SOLVER_H_
...
#endif  // ACADOS_C_OCP_QP_OCP_QP_FULL_CONDENSING_SOLVER_H_