...
% If force is not provided it is default set to true
    ...
    if ~is_casadi_available
        ...
        if isempty(filename)
            error(['Sorry, we could not find a compatible version of CasADi %s for your system.\n' ...
                'Please try manually.\n' ...
                'Instructions can be found at https://web.casadi.org/get/\n' ], ...
                CasADi_version);
        end
        ...
        try
            ...
            error(['Sorry, we could not set up CasADi for your system, please try manually.\n' ...
                ...
                'We recommend using CasADi version %s.'], CasADi_version);
        end
        if ~is_casadi_available
                error(['Sorry, we could not set up CasADi for your system, please try manually.\n' ...
                'Instructions can be found on https://web.casadi.org/get/\n' ...
