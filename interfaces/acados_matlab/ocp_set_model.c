...
//	mexPrintf("\nin sim_set_model\n");
	...
	if (mxGetField( prhs[1], 0, "constr_h_fun_jac_ut_xt" )!=NULL)
		{
	...
	if (mxGetField( prhs[1], 0, "constr_h_e_fun_jac_ut_xt" )!=NULL)
		{
	...
	if (mxGetField( prhs[1], 0, "cost_y_fun_jac_ut_xt" )!=NULL)
		{
	...
	if (mxGetField( prhs[1], 0, "cost_y_e_fun_jac_ut_xt" )!=NULL)
		{
	...
	if (mxGetField( prhs[1], 0, "cost_ext_cost_jac_hes" )!=NULL)
		{
	...
	if (mxGetField( prhs[1], 0, "cost_ext_cost_e_jac_hes" )!=NULL)
		{
