...
//	mexPrintf("\nin sim_impl_ext_fun_create\n");
	...
	memcpy(fieldnames[8],"constr_h_fun_jac_ut_xt",sizeof("constr_h_fun_jac_ut_xt"));
	memcpy(fieldnames[9],"constr_h_fun_jac_ut_xt_hess",sizeof("constr_h_fun_jac_ut_xt_hess"));
	memcpy(fieldnames[10],"constr_h_e_fun_jac_ut_xt",sizeof("constr_h_e_fun_jac_ut_xt"));
	memcpy(fieldnames[11],"constr_h_e_fun_jac_ut_xt_hess",sizeof("constr_h_e_fun_jac_ut_xt_hess"));
	memcpy(fieldnames[12],"cost_y_fun_jac_ut_xt",sizeof("cost_y_fun_jac_ut_xt"));
	memcpy(fieldnames[13],"cost_y_e_fun_jac_ut_xt",sizeof("cost_y_e_fun_jac_ut_xt"));
	memcpy(fieldnames[14],"cost_ext_cost_jac_hes",sizeof("cost_ext_cost_jac_hes"));
	memcpy(fieldnames[15],"cost_ext_cost_e_jac_hes",sizeof("cost_ext_cost_e_jac_hes"));

	// create output struct
	plhs[0] = mxCreateStructMatrix(1, 1, 16, (const char **) fieldnames);
