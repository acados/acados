...
if (strcmp(model_struct.cost_type, 'ext_cost'))
	...
	param = {param{:}, ...
		model_struct.cost_param_ext_cost ...
		};
	phase = {phase{:}, 0};
...
if (strcmp(model_struct.cost_type_e, 'ext_cost'))
	...
	param = {param{:}, ...
		model_struct.cost_param_ext_cost_e ...
		};
	phase = {phase{:}, 1};
...
%		setenv('CFLAGS', cflags_tmp);
	...
	%		mkoctfile -p CFLAGS
			...
			cflags_tmp = [cflags_tmp, ' -DPARAM=', param{ii}];
			...
			mex(mex_flags, 'CFLAGS=\$CFLAGS -std=c99 -fopenmp', ['-DSETTER=', setter{ii}], ['-DSET_FIELD=', set_fields{ii}], ['-DMEX_FIELD=', mex_fields{ii}], ['-DFUN_NAME=', fun_names{ii}], ['-DPARAM=', param{ii}], ['-DPHASE=', num2str(phase{ii})], ['-DN0=', num2str(phase_start{ii})], ['-DN1=', num2str(phase_end{ii})], acados_include, acados_interfaces_include, external_include, blasfeo_include, acados_lib_path, acados_matlab_lib_path, model_lib_path, '-lacados', '-lhpipm', '-lblasfeo', '-locp_model', mex_files{1}); % TODO
