...
CASADI_SYMBOL_EXPORT int ls_cost_nm5(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, int mem){
...
CASADI_SYMBOL_EXPORT int ls_cost_nm5_n_in(void) { return 2;}
