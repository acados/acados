...
/* pathcon_nm3:(i0[12],i1[3])->(o0[0],o1[0x15]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT int pathcon_nm3(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, int mem){
...
CASADI_SYMBOL_EXPORT int pathcon_nm3_n_in(void) { return 2;}
