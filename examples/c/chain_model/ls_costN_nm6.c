...
/* ls_costN_nm6:(i0[30])->(o0[30],o1[30x30]) */
...
CASADI_SYMBOL_EXPORT int ls_costN_nm6(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, int mem){
...
CASADI_SYMBOL_EXPORT int ls_costN_nm6_n_in(void) { return 1;}
