...
static const int CASADI_PREFIX(s0)[] = {24, 1,  0,  24, 0,  1,  2,  3,  4,  5,
...
/* jacFun */
int jac_chain_nm5(void* mem, const real_t** arg, real_t** res, int* iw,
                  real_t* w) {
    mem = 0;
    mem += 0;
    w = 0;
...
int jac_chain_nm5_sparsity(int i, int* nrow, int* ncol, const int** colind,
                           const int** row) {
    const int* s;
    switch (i) {
        case 0:
