...
static const int casadi_s2[9] = {0, 6, 0, 0, 0, 0, 0, 0, 0};
...
CASADI_SYMBOL_EXPORT int pathconN_nm2(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, int mem){
