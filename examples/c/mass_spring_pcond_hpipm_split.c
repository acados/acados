...
int main() {
    ...
    ************************************************/
    ...
    ((ocp_qp_hpipm_opts *)((ocp_qp_partial_condensing_solver_opts *)arg)->qp_solver_opts)->hpipm_opts->iter_max = 10;
    ((ocp_qp_hpipm_opts *)((ocp_qp_partial_condensing_solver_opts *)arg)->qp_solver_opts)->hpipm_opts->res_g_max = 1e-8;

    ocp_qp_solver *qp_solver = ocp_qp_create(&plan,pcond_opts->pcond_dims, arg);
	...
	for (int rep = 0; rep < NREP; rep++) {
        ...
        ocp_qp_partial_condensing(qp_in, pcond_qp_in, pcond_opts, pcond_mem, NULL);

        acados_return = ocp_qp_solve(qp_solver, pcond_qp_in, pcond_qp_out);

        ocp_qp_partial_expansion(pcond_qp_out, qp_out, pcond_opts, pcond_mem, NULL);
	}
    ...
    ************************************************/
    ...
    ocp_qp_hpipm_memory *mem = (ocp_qp_hpipm_memory *)((ocp_qp_partial_condensing_solver_memory *) qp_solver->mem)->solver_memory;
