...
impl_ode_inc_J_x_xdot.generate('impl_ode_fun_jac_x_xdot', opts);
impl_ode_J_x_xdot_u.generate('impl_ode_jac_x_xdot_u', opts);
impl_ode_J_x_u.generate('impl_ode_jac_x_u', opts);
