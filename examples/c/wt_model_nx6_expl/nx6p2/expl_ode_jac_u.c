...
/* expl_ode_jac_u */
CASADI_SYMBOL_EXPORT int expl_ode_jac_u(const real_t** arg, real_t** res, int* iw, real_t* w, int mem) {
  real_t *rr, *ss;
...
CASADI_SYMBOL_EXPORT void expl_ode_jac_u_incref(void) {
}

CASADI_SYMBOL_EXPORT void expl_ode_jac_u_decref(void) {
}

CASADI_SYMBOL_EXPORT int expl_ode_jac_u_n_in(void) { return 3;}

CASADI_SYMBOL_EXPORT int expl_ode_jac_u_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT const char* expl_ode_jac_u_name_in(int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* expl_ode_jac_u_name_out(int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const int* expl_ode_jac_u_sparsity_in(int i) {
  switch (i) {
    case 0: return s2;
    case 1: return s3;
    case 2: return s4;
...
CASADI_SYMBOL_EXPORT const int* expl_ode_jac_u_sparsity_out(int i) {
  switch (i) {
    case 0: return s0;
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT int expl_ode_jac_u_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 11;
  if (sz_res) *sz_res = 2;
  if (sz_iw) *sz_iw = 3;
  if (sz_w) *sz_w = 6;
