...
int main() {
    ...
    ************************************************/
    ...
    ocp_qp_condensing_hpipm_args *arg = ocp_qp_condensing_hpipm_create_arguments(qp_in->dim);

    ocp_qp_condensing_hpipm_memory *mem = ocp_qp_condensing_hpipm_create_memory(qp_in->dim, arg);
