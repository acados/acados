...
static const casadi_int casadi_s3[26] = {6, 14, 0, 2, 3, 3, 4, 5, 6, 6, 6, 6, 6, 9, 9, 9, 9, 3, 4, 5, 4, 5, 5, 2, 3, 5};

casadi_real casadi_sq(casadi_real x) { return x*x;}

/* crane_dae_f_lo_fun_jac_x1k1uz:(i0[5],i1[5],i2[2],i3[2])->(o0[6],o1[6x14,9nz]) */
