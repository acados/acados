...
static const casadi_int casadi_s6[9] = {10, 2, 0, 3, 4, 4, 7, 8, 5};

casadi_real casadi_sq(casadi_real x) { return x*x;}

/* crane_dae_impl_ode_fun_jac_x_xdot_u:(i0[9],i1[9],i2[2],i3)->(o0[10],o1[10x9,14nz],o2[10x9,9nz],o3[10x2,4nz]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem) {
  ...
  a11=3.7072679182318851e+00;
  if (res[1]!=0) res[1][8]=a11;
  a11=1.3803228073658729e+00;
