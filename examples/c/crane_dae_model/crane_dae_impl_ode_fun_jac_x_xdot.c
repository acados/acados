...
static const casadi_int casadi_s3[28] = {11, 9, 0, 3, 7, 8, 10, 13, 13, 15, 16, 16, 4, 8, 9, 0, 1, 4, 10, 1, 4, 9, 3, 4, 10, 5, 6, 6};
...
/* crane_dae_impl_ode_fun_jac_x_xdot:(i0[9],i1[9],i2[2],i3[2])->(o0[11],o1[11x9,16nz],o2[11x9,10nz],o3[11x2,3nz]) */
