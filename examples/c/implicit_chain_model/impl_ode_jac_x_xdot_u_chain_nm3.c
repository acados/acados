...
/* casadi_impl_ode_jac_x_xdot_u_chain_nm3:(i0[12],i1[12],i2[3])->(o0[12x27]) */
...
CASADI_SYMBOL_EXPORT casadi_int casadi_impl_ode_jac_x_xdot_u_chain_nm3_n_out(void) { return 1;}
