...
int casadi_impl_ode_jac_x_chain_nm4_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_chain_nm5_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_chain_nm6_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_chain_nm7_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_chain_nm8_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_chain_nm9_work(int *, int *, int *, int *);

const int *casadi_impl_ode_jac_x_chain_nm2_sparsity_in(int);
const int *casadi_impl_ode_jac_x_chain_nm3_sparsity_in(int);
const int *casadi_impl_ode_jac_x_chain_nm4_sparsity_in(int);
const int *casadi_impl_ode_jac_x_chain_nm5_sparsity_in(int);
const int *casadi_impl_ode_jac_x_chain_nm6_sparsity_in(int);
const int *casadi_impl_ode_jac_x_chain_nm7_sparsity_in(int);
const int *casadi_impl_ode_jac_x_chain_nm8_sparsity_in(int);
const int *casadi_impl_ode_jac_x_chain_nm9_sparsity_in(int);

const int *casadi_impl_ode_jac_x_chain_nm2_sparsity_out(int);
const int *casadi_impl_ode_jac_x_chain_nm3_sparsity_out(int);
const int *casadi_impl_ode_jac_x_chain_nm4_sparsity_out(int);
const int *casadi_impl_ode_jac_x_chain_nm5_sparsity_out(int);
const int *casadi_impl_ode_jac_x_chain_nm6_sparsity_out(int);
const int *casadi_impl_ode_jac_x_chain_nm7_sparsity_out(int);
const int *casadi_impl_ode_jac_x_chain_nm8_sparsity_out(int);
const int *casadi_impl_ode_jac_x_chain_nm9_sparsity_out(int);

int casadi_impl_ode_jac_x_chain_nm2_n_in();
int casadi_impl_ode_jac_x_chain_nm3_n_in();
int casadi_impl_ode_jac_x_chain_nm4_n_in();
int casadi_impl_ode_jac_x_chain_nm5_n_in();
int casadi_impl_ode_jac_x_chain_nm6_n_in();
int casadi_impl_ode_jac_x_chain_nm7_n_in();
int casadi_impl_ode_jac_x_chain_nm8_n_in();
int casadi_impl_ode_jac_x_chain_nm9_n_in();

int casadi_impl_ode_jac_x_chain_nm2_n_out();
int casadi_impl_ode_jac_x_chain_nm3_n_out();
int casadi_impl_ode_jac_x_chain_nm4_n_out();
int casadi_impl_ode_jac_x_chain_nm5_n_out();
int casadi_impl_ode_jac_x_chain_nm6_n_out();
int casadi_impl_ode_jac_x_chain_nm7_n_out();
int casadi_impl_ode_jac_x_chain_nm8_n_out();
...
int casadi_impl_ode_jac_xdot_chain_nm4_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_xdot_chain_nm5_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_xdot_chain_nm6_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_xdot_chain_nm7_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_xdot_chain_nm8_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_xdot_chain_nm9_work(int *, int *, int *, int *);

const int *casadi_impl_ode_jac_xdot_chain_nm2_sparsity_in(int);
const int *casadi_impl_ode_jac_xdot_chain_nm3_sparsity_in(int);
const int *casadi_impl_ode_jac_xdot_chain_nm4_sparsity_in(int);
const int *casadi_impl_ode_jac_xdot_chain_nm5_sparsity_in(int);
const int *casadi_impl_ode_jac_xdot_chain_nm6_sparsity_in(int);
const int *casadi_impl_ode_jac_xdot_chain_nm7_sparsity_in(int);
const int *casadi_impl_ode_jac_xdot_chain_nm8_sparsity_in(int);
const int *casadi_impl_ode_jac_xdot_chain_nm9_sparsity_in(int);

const int *casadi_impl_ode_jac_xdot_chain_nm2_sparsity_out(int);
const int *casadi_impl_ode_jac_xdot_chain_nm3_sparsity_out(int);
const int *casadi_impl_ode_jac_xdot_chain_nm4_sparsity_out(int);
const int *casadi_impl_ode_jac_xdot_chain_nm5_sparsity_out(int);
const int *casadi_impl_ode_jac_xdot_chain_nm6_sparsity_out(int);
const int *casadi_impl_ode_jac_xdot_chain_nm7_sparsity_out(int);
const int *casadi_impl_ode_jac_xdot_chain_nm8_sparsity_out(int);
const int *casadi_impl_ode_jac_xdot_chain_nm9_sparsity_out(int);

int casadi_impl_ode_jac_xdot_chain_nm2_n_in();
int casadi_impl_ode_jac_xdot_chain_nm3_n_in();
int casadi_impl_ode_jac_xdot_chain_nm4_n_in();
int casadi_impl_ode_jac_xdot_chain_nm5_n_in();
int casadi_impl_ode_jac_xdot_chain_nm6_n_in();
int casadi_impl_ode_jac_xdot_chain_nm7_n_in();
int casadi_impl_ode_jac_xdot_chain_nm8_n_in();
int casadi_impl_ode_jac_xdot_chain_nm9_n_in();

int casadi_impl_ode_jac_xdot_chain_nm2_n_out();
int casadi_impl_ode_jac_xdot_chain_nm3_n_out();
int casadi_impl_ode_jac_xdot_chain_nm4_n_out();
int casadi_impl_ode_jac_xdot_chain_nm5_n_out();
int casadi_impl_ode_jac_xdot_chain_nm6_n_out();
int casadi_impl_ode_jac_xdot_chain_nm7_n_out();
int casadi_impl_ode_jac_xdot_chain_nm8_n_out();
...
int casadi_impl_ode_jac_u_chain_nm4_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_u_chain_nm5_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_u_chain_nm6_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_u_chain_nm7_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_u_chain_nm8_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_u_chain_nm9_work(int *, int *, int *, int *);

const int *casadi_impl_ode_jac_u_chain_nm2_sparsity_in(int);
const int *casadi_impl_ode_jac_u_chain_nm3_sparsity_in(int);
const int *casadi_impl_ode_jac_u_chain_nm4_sparsity_in(int);
const int *casadi_impl_ode_jac_u_chain_nm5_sparsity_in(int);
const int *casadi_impl_ode_jac_u_chain_nm6_sparsity_in(int);
const int *casadi_impl_ode_jac_u_chain_nm7_sparsity_in(int);
const int *casadi_impl_ode_jac_u_chain_nm8_sparsity_in(int);
const int *casadi_impl_ode_jac_u_chain_nm9_sparsity_in(int);

const int *casadi_impl_ode_jac_u_chain_nm2_sparsity_out(int);
const int *casadi_impl_ode_jac_u_chain_nm3_sparsity_out(int);
const int *casadi_impl_ode_jac_u_chain_nm4_sparsity_out(int);
const int *casadi_impl_ode_jac_u_chain_nm5_sparsity_out(int);
const int *casadi_impl_ode_jac_u_chain_nm6_sparsity_out(int);
const int *casadi_impl_ode_jac_u_chain_nm7_sparsity_out(int);
const int *casadi_impl_ode_jac_u_chain_nm8_sparsity_out(int);
const int *casadi_impl_ode_jac_u_chain_nm9_sparsity_out(int);

int casadi_impl_ode_jac_u_chain_nm2_n_in();
int casadi_impl_ode_jac_u_chain_nm3_n_in();
int casadi_impl_ode_jac_u_chain_nm4_n_in();
int casadi_impl_ode_jac_u_chain_nm5_n_in();
int casadi_impl_ode_jac_u_chain_nm6_n_in();
int casadi_impl_ode_jac_u_chain_nm7_n_in();
int casadi_impl_ode_jac_u_chain_nm8_n_in();
int casadi_impl_ode_jac_u_chain_nm9_n_in();

int casadi_impl_ode_jac_u_chain_nm2_n_out();
int casadi_impl_ode_jac_u_chain_nm3_n_out();
int casadi_impl_ode_jac_u_chain_nm4_n_out();
int casadi_impl_ode_jac_u_chain_nm5_n_out();
int casadi_impl_ode_jac_u_chain_nm6_n_out();
int casadi_impl_ode_jac_u_chain_nm7_n_out();
int casadi_impl_ode_jac_u_chain_nm8_n_out();
...
int casadi_impl_ode_jac_x_u_chain_nm4_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_u_chain_nm5_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_u_chain_nm6_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_u_chain_nm7_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_u_chain_nm8_work(int *, int *, int *, int *);
int casadi_impl_ode_jac_x_u_chain_nm9_work(int *, int *, int *, int *);

const int *casadi_impl_ode_jac_x_u_chain_nm2_sparsity_in(int);
const int *casadi_impl_ode_jac_x_u_chain_nm3_sparsity_in(int);
const int *casadi_impl_ode_jac_x_u_chain_nm4_sparsity_in(int);
const int *casadi_impl_ode_jac_x_u_chain_nm5_sparsity_in(int);
const int *casadi_impl_ode_jac_x_u_chain_nm6_sparsity_in(int);
const int *casadi_impl_ode_jac_x_u_chain_nm7_sparsity_in(int);
const int *casadi_impl_ode_jac_x_u_chain_nm8_sparsity_in(int);
const int *casadi_impl_ode_jac_x_u_chain_nm9_sparsity_in(int);

const int *casadi_impl_ode_jac_x_u_chain_nm2_sparsity_out(int);
const int *casadi_impl_ode_jac_x_u_chain_nm3_sparsity_out(int);
const int *casadi_impl_ode_jac_x_u_chain_nm4_sparsity_out(int);
const int *casadi_impl_ode_jac_x_u_chain_nm5_sparsity_out(int);
const int *casadi_impl_ode_jac_x_u_chain_nm6_sparsity_out(int);
const int *casadi_impl_ode_jac_x_u_chain_nm7_sparsity_out(int);
const int *casadi_impl_ode_jac_x_u_chain_nm8_sparsity_out(int);
const int *casadi_impl_ode_jac_x_u_chain_nm9_sparsity_out(int);

int casadi_impl_ode_jac_x_u_chain_nm2_n_in();
int casadi_impl_ode_jac_x_u_chain_nm3_n_in();
int casadi_impl_ode_jac_x_u_chain_nm4_n_in();
int casadi_impl_ode_jac_x_u_chain_nm5_n_in();
int casadi_impl_ode_jac_x_u_chain_nm6_n_in();
int casadi_impl_ode_jac_x_u_chain_nm7_n_in();
int casadi_impl_ode_jac_x_u_chain_nm8_n_in();
int casadi_impl_ode_jac_x_u_chain_nm9_n_in();

int casadi_impl_ode_jac_x_u_chain_nm2_n_out();
int casadi_impl_ode_jac_x_u_chain_nm3_n_out();
int casadi_impl_ode_jac_x_u_chain_nm4_n_out();
int casadi_impl_ode_jac_x_u_chain_nm5_n_out();
int casadi_impl_ode_jac_x_u_chain_nm6_n_out();
int casadi_impl_ode_jac_x_u_chain_nm7_n_out();
int casadi_impl_ode_jac_x_u_chain_nm8_n_out();
int casadi_impl_ode_jac_x_u_chain_nm9_n_out();
