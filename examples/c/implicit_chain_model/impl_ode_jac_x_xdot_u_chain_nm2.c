...
/* casadi_impl_ode_jac_x_xdot_u_chain_nm2:(i0[6],i1[6],i2[3])->(o0[6x15]) */
...
CASADI_SYMBOL_EXPORT casadi_int casadi_impl_ode_jac_x_xdot_u_chain_nm2_n_out(void) { return 1;}
