...
CASADI_SYMBOL_EXPORT int casadi_impl_ode_jac_x_u_chain_nm4(const real_t** arg, real_t** res, int* iw, real_t* w, int mem) {
  ...
  a10=(a22*a10);
  a10=(-a10);
  if (res[0]!=0) res[0][243]=a10;
  a10=(a19*a12);
  a10=(a10+a11);
  a10=(a22*a10);
  a10=(-a10);
  if (res[0]!=0) res[0][244]=a10;
  a12=(a5*a12);
  a12=(a22*a12);
  a12=(-a12);
  ...
  a18=(a22*a18);
  a18=(-a18);
  if (res[0]!=0) res[0][261]=a18;
  a19=(a19*a8);
  a19=(a22*a19);
  a19=(-a19);
  if (res[0]!=0) res[0][262]=a19;
  a5=(a5*a8);
  a5=(a5+a11);
  a22=(a22*a5);
  a22=(-a22);
...
CASADI_SYMBOL_EXPORT int casadi_impl_ode_jac_x_u_chain_nm4_n_in(void) { return 3;}

CASADI_SYMBOL_EXPORT int casadi_impl_ode_jac_x_u_chain_nm4_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT const char* casadi_impl_ode_jac_x_u_chain_nm4_name_in(int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* casadi_impl_ode_jac_x_u_chain_nm4_name_out(int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const int* casadi_impl_ode_jac_x_u_chain_nm4_sparsity_in(int i) {
  switch (i) {
    case 0: return s0;
    case 1: return s0;
    case 2: return s1;
...
CASADI_SYMBOL_EXPORT const int* casadi_impl_ode_jac_x_u_chain_nm4_sparsity_out(int i) {
  switch (i) {
    case 0: return s2;
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT int casadi_impl_ode_jac_x_u_chain_nm4_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 3;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 24;
