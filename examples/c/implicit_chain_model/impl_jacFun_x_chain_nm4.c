...
#else /* CODEGEN_PREFIX */
  #define CASADI_PREFIX(ID) impl_jacFun_x_chain_nm4_ ## ID
...
void impl_jacFun_x_chain_nm4_incref(void) {
}

void impl_jacFun_x_chain_nm4_decref(void) {
}

int impl_jacFun_x_chain_nm4_n_in(void) { return 3;}

int impl_jacFun_x_chain_nm4_n_out(void) { return 1;}

const char* impl_jacFun_x_chain_nm4_name_in(int i){
  switch (i) {
  case 0: return "i0";
  case 1: return "i1";
  case 2: return "i2";
...
const char* impl_jacFun_x_chain_nm4_name_out(int i){
  switch (i) {
  case 0: return "o0";
  default: return 0;
  }
...
const int* impl_jacFun_x_chain_nm4_sparsity_in(int i) {
  switch (i) {
  case 0: return s0;
  case 1: return s0;
  case 2: return s1;
...
const int* impl_jacFun_x_chain_nm4_sparsity_out(int i) {
  switch (i) {
  case 0: return s2;
  default: return 0;
  }
...
int impl_jacFun_x_chain_nm4_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 3;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 24;
