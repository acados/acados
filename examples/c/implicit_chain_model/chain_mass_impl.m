...
for Nm = 2:10
    ...
    impl_odeFun = Function(['casadi_impl_ode_fun_chain_nm' num2str(Nm)], {dae.x, dae.x_dot, dae.p}, {ode_impl});
    impl_jacFun_x = Function(['casadi_impl_ode_jac_x_chain_nm' num2str(Nm)], {dae.x, dae.x_dot, dae.p}, {jac_x});
    impl_jacFun_xdot = Function(['casadi_impl_ode_jac_xdot_chain_nm' num2str(Nm)], {dae.x, dae.x_dot, dae.p}, {jac_xdot});
    impl_jacFun_u = Function(['casadi_impl_ode_jac_u_chain_nm' num2str(Nm)], {dae.x, dae.x_dot, dae.p}, {jac_u});
    ...
    impl_odeFun.generate(['impl_ode_fun_chain_nm' num2str(Nm)], opts);
    impl_jacFun_x.generate(['impl_ode_jac_x_chain_nm' num2str(Nm)], opts);
    impl_jacFun_xdot.generate(['impl_ode_jac_xdot_chain_nm' num2str(Nm)], opts);
    impl_jacFun_u.generate(['impl_ode_jac_u_chain_nm' num2str(Nm)], opts);
