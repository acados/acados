...
/* casadi_impl_ode_jac_x_xdot_u_chain_nm4:(i0[18],i1[18],i2[3])->(o0[18x39]) */
...
CASADI_SYMBOL_EXPORT casadi_int casadi_impl_ode_jac_x_xdot_u_chain_nm4_n_out(void) { return 1;}
