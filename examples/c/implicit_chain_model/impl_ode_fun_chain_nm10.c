...
/* casadi_impl_ode_fun_chain_nm10 */
CASADI_SYMBOL_EXPORT int casadi_impl_ode_fun_chain_nm10(const real_t** arg, real_t** res, int* iw, real_t* w, int mem) {
...
CASADI_SYMBOL_EXPORT int casadi_impl_ode_fun_chain_nm10_n_in(void) { return 3;}

CASADI_SYMBOL_EXPORT int casadi_impl_ode_fun_chain_nm10_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT const char* casadi_impl_ode_fun_chain_nm10_name_in(int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* casadi_impl_ode_fun_chain_nm10_name_out(int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const int* casadi_impl_ode_fun_chain_nm10_sparsity_in(int i) {
  switch (i) {
    case 0: return s0;
    case 1: return s0;
    case 2: return s1;
...
CASADI_SYMBOL_EXPORT const int* casadi_impl_ode_fun_chain_nm10_sparsity_out(int i) {
  switch (i) {
    case 0: return s0;
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT int casadi_impl_ode_fun_chain_nm10_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 3;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 15;
