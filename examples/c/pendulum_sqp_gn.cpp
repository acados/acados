...
int main() {
	...
	// NLP solution
    acados_timer timer;
	double kkt_norm_inf = __builtin_inf(), elapsed_time = 0, total_time = 0;
	
	int solver_status = 0, iteration_number = 0;
	// for (int j = 0; j < 100; ++j) {
	// 	kkt_norm_inf = __builtin_inf(), elapsed_time = 0, total_time = 0;
    ...
    printf("\n\nstatus = %i, avg time = %f ms, iters = %d\n\n", solver_status, total_time/iteration_number, nlp_out->sqp_iter);
