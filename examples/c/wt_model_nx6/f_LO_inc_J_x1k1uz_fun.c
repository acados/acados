...
#else /* CODEGEN_PREFIX */
  #define CASADI_PREFIX(ID) f_LO_inc_J_x1k1uz_fun_ ## ID
...
CASADI_SYMBOL_EXPORT void casadi_f_LO_inc_J_x1k1uz_fun_incref(void) {
}

CASADI_SYMBOL_EXPORT void casadi_f_LO_inc_J_x1k1uz_fun_decref(void) {
}

CASADI_SYMBOL_EXPORT int casadi_f_LO_inc_J_x1k1uz_fun_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT int casadi_f_LO_inc_J_x1k1uz_fun_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT const char* casadi_f_LO_inc_J_x1k1uz_fun_name_in(int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* casadi_f_LO_inc_J_x1k1uz_fun_name_out(int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const int* casadi_f_LO_inc_J_x1k1uz_fun_sparsity_in(int i) {
  switch (i) {
    case 0: return s0;
    case 1: return s0;
    case 2: return s1;
...
CASADI_SYMBOL_EXPORT const int* casadi_f_LO_inc_J_x1k1uz_fun_sparsity_out(int i) {
  switch (i) {
    case 0: return s3;
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT int casadi_f_LO_inc_J_x1k1uz_fun_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
