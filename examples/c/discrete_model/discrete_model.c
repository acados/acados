...
#else /* CODEGEN_PREFIX */
  #define CASADI_PREFIX(ID) discrete_model_ ## ID
...
static const int CASADI_PREFIX(s1)[7] = {1, 2, 0, 1, 2, 0, 0};
...
int discrete_model_n_in(void) { return 2;}

int discrete_model_n_out(void) { return 2;}
