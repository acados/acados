...
static const casadi_int casadi_s5[35] = {18, 18, 0, 2, 5, 5, 6, 7, 9, 9, 9, 9, 9, 9, 9, 9, 9, 11, 12, 13, 14, 14, 16, 14, 15, 17, 5, 5, 3, 4, 0, 1, 1, 0, 1};

/* inv_pendulum_dyn_impl_ode_hess:(i0[6],i1[6],i2,i3[5],i4[11],i5[])->(o0[18x18,14nz]) */
