...
static const casadi_int casadi_s4[20] = {11, 6, 0, 2, 4, 6, 8, 11, 11, 7, 9, 7, 8, 0, 9, 1, 8, 8, 9, 10};
...
/* inv_pendulum_impl_ode_fun_jac_x_xdot_u:(i0[6],i1[6],i2,i3[5])->(o0[11],o1[11x6,11nz],o2[11x6,6nz],o3[11x5,14nz]) */
